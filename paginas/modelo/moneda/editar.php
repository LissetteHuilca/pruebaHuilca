...
<html>
    ...
    <body>
        ...
        <?php 
                ...
                $ObjMoneda=$monedaCollectorObj->showMoneda($id);
        ?>
                    ...
                    <div class="col-md-4">
                        <form method="post" action="Actualizar.php" enctype="multipart/form-data">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="idu" value="<?php echo $ObjMoneda->getIdmoneda(); ?>" readonly name="idmoneda">
                            </div>
                             <div class="form-group">
                              <label for="metodo">Nombre</label>
                              <input type="text" class="form-control" id="metodo" value="<?php echo $ObjMoneda->getNombre(); ?>" name="nombre">
                            </div>
